	...
	<aside class="offcanvas-md offcanvas-start border-end border-dark position-fixed" tabindex="-1"
		...
		<div class="offcanvas-body p-md-3 w-100">
			<nav class="nav flex-column w-100">
				% # This assumes that this is located in the pod subdirectory on the PG GitHub pages site, and that the
				% # PG doc index is located in the directory containing the pod subdirectory.
				<a href=".." class="nav-link">PG Documentation Home</a>
				<hr>
				<%= $index =%>
			</nav>
		</div>
